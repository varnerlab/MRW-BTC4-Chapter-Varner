...
\end{equation}
where $\mathbf{x}$ is the vector of intracellular metabolite concentrations and
$\mu$ is the specific growth rate (dilution by cell growth).  Metabolic fluxes
...
$V_{\max,\text{v2}} = 0.0328$\,mmol\,gDW$^{-1}$\,h$^{-1}$.
