...
Consider a well-mixed bioreactor of volume $V$ holding a growing cell
...
point for the complete derivation carried out in
Appendix~\ref{sec:appendix}.

Two steps turn Equation~\eqref{eq:mole-balance} into a statement about
fluxes alone. First, writing the reactor volume in specific units,
$V=B\bar V$, with $B$ the total biomass in the reactor and $\bar V$ the
culture volume per unit biomass, ties the extensive balance to the
biomass that is actually growing; the specific growth rate is then
$\mu\equiv(1/B)\,dB/dt$. Second, expanding the accumulation term
$d(C_iV)/dt=d(C_iB\bar V)/dt$ by the product rule produces, alongside a
term in $dC_i/dt$, a term proportional to $\mu$: the growth-dilution
term. If the intracellular pool of species $i$ is at pseudo-steady state
...
\eqref{eq:mole-balance} collapses to
...
its own growing culture. The full reduction from
Equation~\eqref{eq:mole-balance} to Equation~\eqref{eq:honest-constraint},
including the product-rule expansion, is given in
Appendix~\ref{sec:appendix}.
